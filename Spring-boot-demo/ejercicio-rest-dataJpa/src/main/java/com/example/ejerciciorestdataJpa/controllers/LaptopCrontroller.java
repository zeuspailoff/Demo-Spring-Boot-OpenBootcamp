package com.example.ejerciciorestdataJpa.controllers;


import com.example.ejerciciorestdataJpa.entities.Laptop;

import com.example.ejerciciorestdataJpa.repository.LaptopRepository;
...
@RestController
public class LaptopCrontroller {

    private final Logger log = LoggerFactory.getLogger(LaptopCrontroller.class);
    private LaptopRepository laptopRepository;

    public LaptopCrontroller(LaptopRepository bookRepository) {
